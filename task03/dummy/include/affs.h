...
#define AFFS_TAIL(sb, bh)                                        \
	((struct affs_tail *)((bh)->b_data + (sb)->s_blocksize - \
			      sizeof(struct affs_tail)))
#define AFFS_ROOT_HEAD(bh) ((struct affs_root_head *)(bh)->b_data)
#define AFFS_ROOT_TAIL(sb, bh)                                        \
	((struct affs_root_tail *)((bh)->b_data + (sb)->s_blocksize - \
...
__printf(3, 4) extern void affs_error(struct super_block *sb,
				      const char *function, const char *fmt,
				      ...);
__printf(3, 4) extern void affs_warning(struct super_block *sb,
					const char *function, const char *fmt,
					...);
extern bool affs_nofilenametruncate(const struct dentry *dentry);
extern int affs_check_name(const unsigned char *name, int len, bool notruncate);
...
extern int affs_symlink(struct mnt_idmap *idmap, struct inode *dir,
			struct dentry *dentry, const char *symname);
extern int affs_rename2(struct mnt_idmap *idmap, struct inode *old_dir,
...
extern int affs_setattr(struct mnt_idmap *idmap, struct dentry *dentry,
			struct iattr *attr);
extern void affs_evict_inode(struct inode *inode);
extern struct inode *affs_iget(struct super_block *sb, unsigned long ino);
extern int affs_write_inode(struct inode *inode, struct writeback_control *wbc);
...
static inline struct buffer_head *affs_bread(struct super_block *sb, int block)
{
	pr_debug("%s: %d\n", __func__, block);
...
static inline struct buffer_head *affs_getblk(struct super_block *sb, int block)
{
	pr_debug("%s: %d\n", __func__, block);
	if (affs_validblock(sb, block))
